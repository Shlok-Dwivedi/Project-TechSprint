      ...
      <div className="w-1/5 border-r border-slate-200 bg-white hidden lg:block sticky top-20 h-[calc(100vh-80px)] overflow-y-auto shrink-0">
        <div className="p-6">
          ...
          <ul className="space-y-1">
            <li>
              <span className="block px-2 py-1.5 text-sm font-medium text-blue-600 bg-blue-50 rounded-md cursor-default">
                1. Overview
              </span>
            </li>
            <li>
              <span className="block px-2 py-1.5 text-sm font-medium text-slate-600 cursor-default">
                2. Intuition
              </span>
            </li>
            <li>
